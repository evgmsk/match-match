...
export const MenuLevel = document.getElementById('menu-level');
export const ButtonSkirt = document.getElementById('button-skirt');
export const ButtonLevel = document.getElementById('button-level');
